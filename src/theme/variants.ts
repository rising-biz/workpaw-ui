...
export const THEME_VARIANTS: readonly VariantMeta[] = [
  {
    id: "indigo",
    name: "夜靛",
    desc: "深邃靛蓝 + 冷调中性色。品牌默认，冷静、权威、专注，如精密仪器。",
    preview: {
      bg: "oklch(0.97 0.007 260)",
      fg: "oklch(0.22 0.03 262)",
      primary: "oklch(0.48 0.24 262)",
      border: "oklch(0.87 0.014 262)",
    },
  },
  {
    id: "verdant",
    name: "翠微",
    desc: "深翠绿强调 + 微绿中性色。自然、信赖、专业，控制塔级精密质感。",
    preview: {
      bg: "oklch(0.97 0.006 155)",
      fg: "oklch(0.22 0.02 155)",
      primary: "oklch(0.50 0.22 158)",
      border: "oklch(0.87 0.014 155)",
    },
  },
  {
    id: "amber",
    ...
    preview: {
      bg: "oklch(0.97 0.007 85)",
      fg: "oklch(0.22 0.02 85)",
  ...
  },
  {
    ...
    preview: {
      bg: "oklch(0.97 0.008 290)",
      fg: "oklch(0.22 0.03 290)",
      primary: "oklch(0.50 0.24 290)",
      border: "oklch(0.87 0.016 290)",
    },
  },
];
