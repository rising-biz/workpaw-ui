...
| workpaw-admin/console | `~/github/workpaw-admin/console` | 管理后台 |
| workpaw-admin | `~/github/workpaw-admin` | Control Plane API |
...
```
Agent A: [workpaw-admin/console] 页面开发（Dashboard/Instances/AuditLogs/Policy/OIDC）
Agent B: [workpaw-admin] 管理 API（/api/admin/*）+ 审计日志持久化
```
...
Stream C (workpaw-admin) → Tasks 3.1 - 3.7
...
## Stream C: workpaw-admin（Control Plane API）

### Task 3.1: Control Plane 项目脚手架

**Files:**
- Create: `~/github/workpaw-admin/` (entire project)
- Create: `~/github/workpaw-admin/CLAUDE.md`

- [ ] **Step 1: 初始化 Go 项目**

```bash
cd ~/github
mkdir -p workpaw-admin && cd workpaw-admin
go mod init github.com/workpaw/workpaw-admin
```

- [ ] **Step 2: 安装依赖**

```bash
cd ~/github/workpaw-admin
...
git add .
git commit -m "feat: initialize workpaw-admin project"
```

### Task 3.2: OIDC + JWT 认证

**Files:**
- Create: `~/github/workpaw-admin/internal/service/oidc.go`
- Create: `~/github/workpaw-admin/internal/service/jwt.go`
- Create: `~/github/workpaw-admin/internal/handler/auth.go`
...
**Files:**
- Create: `~/github/workpaw-admin/internal/service/instance.go`
- Create: `~/github/workpaw-admin/internal/handler/instance.go`
...
**Files:**
- Create: `~/github/workpaw-admin/internal/middleware/auth.go`
- Create: `~/github/workpaw-admin/internal/middleware/logger.go`
- Create: `~/github/workpaw-admin/internal/middleware/requestid.go`
- Create: `~/github/workpaw-admin/internal/middleware/cors.go`
- Create: `~/github/workpaw-admin/internal/router/router.go`
...
import (
	"github.com/gin-gonic/gin"
	"github.com/workpaw/workpaw-admin/internal/config"
	"github.com/workpaw/workpaw-admin/internal/handler"
	"github.com/workpaw/workpaw-admin/internal/middleware"
	"github.com/workpaw/workpaw-admin/internal/service"
	"go.uber.org/zap"
)
...
**Files:**
- Create: `~/github/workpaw-admin/Dockerfile`
- Create: `~/github/workpaw-admin/deploy/k8s.yaml`
  ...
  template:
    metadata:
      labels:
        app: workpaw-admin
    spec:
      serviceAccountName: workpaw-admin
      containers:
        - name: control-plane
